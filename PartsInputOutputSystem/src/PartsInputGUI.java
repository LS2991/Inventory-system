...
public class PartsInputGUI extends JFrame implements ActionListener, Observer{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(action.equals("Submit2")) {
			...
			builder.setPAD(buttonArray[10].getText(), firstPane.getMaxMonths());
			builder.setRIPR(buttonArray[11].getText(), firstPane.getMaxMonths());
			builder.setEEMD(buttonArray[12].getText(), firstPane.getMaxMonths());
			builder.setPodAdapter(buttonArray[13].getText(), firstPane.getMaxMonths());
			setPane(buttonPane);
	...
	public void setBuilderValues() {
		...
		else if(textPane.getNameFromButtonPanel().equals(buttonArray[10].getText())) {		
			setBuilderValuesHelper(builder.getPAD());
		}
		else if(textPane.getNameFromButtonPanel().equals(buttonArray[11].getText())) {		
			setBuilderValuesHelper(builder.getRIPR());
		}
		else if(textPane.getNameFromButtonPanel().equals(buttonArray[12].getText())) {		
			setBuilderValuesHelper(builder.getEEMD());
		}
		else if(textPane.getNameFromButtonPanel().equals(buttonArray[13].getText())) {		
			setBuilderValuesHelper(builder.getPodAdapter());
		}
	}
