...
public class ButtonsPanel extends JPanel implements ActionListener, Subject {
	...
	protected JButton[] buttonArray = new JButton[15];
	...
	public ButtonsPanel() {
		...
		buttonArray[10].setText("PAD");
		buttonArray[11].setText("RIPR");
		buttonArray[12].setText("EEMD");
		buttonArray[13].setText("Pod Adapter");
	}
